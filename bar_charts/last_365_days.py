...
plot_bar_chart(daily_spending['Day'].astype(str), daily_spending['Bedrag'], xlabel='Day', ylabel='Spending', title='Spending Over the Last 365 Days Grouped by Day', save_file='../output/last_365_days.png')
