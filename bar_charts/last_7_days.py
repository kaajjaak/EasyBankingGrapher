...
filtered_data = filter_data_by_days(negative_values, 7)
...
date_range = pd.date_range(latest_date - timedelta(days=6), latest_date).to_period('D')
...
plot_bar_chart(daily_spending['Day'].astype(str), daily_spending['Bedrag'], xlabel='Day', ylabel='Spending', title='Spending Over the Last 7 Days Grouped by Day', save_file='../output/last_7_days.png')
